...
import  Tenant from '../../../components/catalog/catalogsidebar/tenant/tenant'; // 直接导入components就可解析
...
* */
export function mapStateToProps( params, ownProps) {
    return {
        ...ownProps
    }
}
...
export function mapDispatchToProps(dispatch) {
    return {
        ...
        onRecordSecondCategories: (secondCategories) => dispatch(Actions.recordSecondCategories(secondCategories)),
...
export default connect(mapStateToProps, mapDispatchToProps, mergeProps)(Tenant);