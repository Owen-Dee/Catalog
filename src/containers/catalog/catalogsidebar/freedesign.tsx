import  FreeDesign from '../../../components/catalog/catalogsidebar/freedesign/freedesign'; // 直接导入components就可解析
...
export default connect(mapStateToProps, mapDispatchToProps, mergeProps)(FreeDesign);